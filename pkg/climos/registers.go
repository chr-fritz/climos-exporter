...
// 0x62 is the exception: it stays out of that dump and first reached the bus on
// 2026-09-12, so its width comes from a frame that carried it behind 0x2e.
var registerWidths = map[Register]int{
	...
	0x5f: 2, 0x60: 2, 0x61: 1, 0x62: 1, 0x63: 2,
